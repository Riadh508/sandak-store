...
[Setup]
AppId=SandakAccounting300
AppName={#MyAppName}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
AppPublisherURL={#MyAppURL}
DefaultDirName={autopf}\Sandak\AccountingSystem_v3.0.0_Setup
...
[Files]
Source: "C:/Users/SEANDS~1/AppData/Local/Temp/sandak_build/AccountingSystem_v2.1.0_Setup\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
