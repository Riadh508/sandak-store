#define MyAppName "نظام إدارة المدارس"
#define MyAppVersion "2.5.0"
#define MyAppPublisher "Sandak Store"
#define MyAppURL "https://sandak-store.com"

[Setup]
AppId=SandakSchool250
AppName={#MyAppName}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
AppPublisherURL={#MyAppURL}
DefaultDirName={autopf}\Sandak\SchoolSystem_v2.5.0_Setup
...
[Files]
Source: "C:/Users/SEANDS~1/AppData/Local/Temp/sandak_build/SchoolSystem_v1.5.0_Setup\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
