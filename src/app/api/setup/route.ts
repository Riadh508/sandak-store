...
const defaultProducts = [
  { name: 'كتاب تعلم البرمجة من الصفر حتى الاحتراف', description: 'دليلك الشامل لتعلم البرمجة من الصفر المطلق حتى الاحتراف', longDescription: 'كتاب شامل ومتكامل يأخذ بيدك في رحلة تعلم البرمجة من الصفر المطلق حتى المستوى المتقدم.', price: 25, category: 'ebook', image: '/covers/02-learn-programming.svg', features: JSON.stringify(['كتاب إلكتروني شامل', 'شرح مبسط للمبتدئين', 'أكثر من 200 مثال عملي', 'تمارين مع حلول']), badge: '', sortOrder: 1 },
