...
const defaultProducts = [
  ...
  { name: 'كتاب التسويق الرقمي الاحترافي', description: 'أتقن استراتيجيات التسويق الرقمي وزد مبيعاتك بنسبة تصل إلى 300%', longDescription: 'كتاب متخصص في التسويق الرقمي يقدم استراتيجيات مجربة لزيادة المبيعات.', price: 20, category: 'ebook', image: '/covers/01-digital-marketing.png', features: JSON.stringify(['استراتيجيات SEO', 'التسويق عبر السوشيال ميديا', 'إعلانات Google', 'تحليل البيانات']), badge: '', sortOrder: 2 },
  ...
  { name: 'كتاب تصميم واجهات المستخدم UI/UX', description: 'تعلم أساسيات تصميم واجهات المستخدم وتجربة المستخدم', longDescription: 'كتاب متخصص يقدم أسس التصميم الرقمي بطريقة عملية.', price: 28, category: 'ebook', image: '/covers/05-ui-ux-design.png', features: JSON.stringify(['نظرية الألوان', 'Figma', 'تصميم متجاوب', '10 مشاريع عملية']), badge: 'مميز', sortOrder: 5 },
  ...
  { name: 'نظام الفواتير الاحترافي', description: 'نظام احترافي لإنشاء وإدارة الفواتير', longDescription: 'نظام متكامل لإدارة الفواتير مع تقارير مالية.', price: 199, category: 'software', image: '/covers/20-invoice-system.png', features: JSON.stringify(['فواتير احترافية', 'تتبع المدفوعات', 'تقارير مالية', 'تصدير PDF']), badge: '', sortOrder: 8 },
  { name: 'متجر سندك v4 — نظام متجر إلكتروني متكامل', description: 'نظام متجر إلكتروني جاهز مع لوحة تحكم ونظام طلبات', longDescription: 'نظام متجر إلكتروني متكامل مبني بـ Next.js + TypeScript + Prisma.', price: 499, category: 'software', image: '/covers/27-sandak-store.png', features: JSON.stringify(['لوحة تحكم', 'نظام مصادقة', 'سلة تسوق', 'فواتير']), badge: 'نظام متكامل', sortOrder: 9 },
];
